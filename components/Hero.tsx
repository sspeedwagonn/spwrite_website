...
const Hero = () => {
    return (
        <div className="bg-gray-50">
            ...
            <p className="py-4 text-center text-gray-700 text-[20px]">Revolutionizing the writing experience with innovative design and advanced<br/>technology, tailored for authors and... 100% free.</p>
